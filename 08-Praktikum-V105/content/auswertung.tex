...
\begin{table}
  	...
  	\input{content/tables/taba.tex}\label{tab:Gravitation}
\end{table}
\begin{figure}
	\centering
...
\begin{table}
  	...
  	\input{content/tables/tabb.tex}\label{tab:Schwingungsdauer}
\end{table}
\begin{figure}
	\centering
	\includegraphics[scale = 1,keepaspectratio]
...
Mithilfe der Messwerte für $I$ aus Tabelle \ref{tab:Präzession} werden mit Formel \eqref{eq:B} die jeweiligen magnetischen Flussdichten $B$ bestimmt. Der Drehimpuls $L_.K$ der Kugel kann mit Formel \eqref{eq:L} bestimmt werden zu:
\begin{equation*}
...
\begin{table}
  	...
  	\input{content/tables/tabc.tex}\label{tab:Präzession}
\end{table}
\begin{figure}
	\centering
	\includegraphics[scale = 1,keepaspectratio]
