...
plt.savefig("content/images/Temperaturen")
...
plt.xlim(3.075, 3.405)
plt.xlabel(r'$T^{-1}/\si[per-mode=reciprocal]{\per\milli\kelvin}$')
plt.ylabel(r'$\ln\left(\frac{p}{p_0}\right)$')
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
plt.legend(loc="best")
plt.savefig("content/images/Dampfdruck")
