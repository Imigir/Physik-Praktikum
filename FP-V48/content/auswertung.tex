...
\begin{minipage}[t]{0.5\textwidth}
	\centering
	\input{content/tables/tabData1_1.tex}
\end{minipage}
\begin{minipage}[t]{0.65\textwidth}
	\centering
	\input{content/tables/tabData1_2.tex}
\end{minipage}
\label{tab:data1}
\end{table}
...
%\begin{table}
	\centering
	\input{content/tables/tabLog11.tex}
	\label{tab:dataW1_1}
%\end{table}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
%\begin{table}
	\centering
	\input{content/tables/tabLog12.tex}
	\label{tab:dataW1_2}
%\end{table}
\end{minipage}
\end{table}
...
\begin{minipage}[t]{0.5\textwidth}
	\centering
	\input{content/tables/tabData2_1.tex}
\end{minipage}
\begin{minipage}[t]{0.65\textwidth}
	\centering
	\input{content/tables/tabData2_2.tex}
\end{minipage}
\label{tab:data2}
\end{table}
...
%\begin{table}
	\centering
	\input{content/tables/tabLog21.tex}
	\label{tab:dataW2_1}
%\end{table}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
%\begin{table}
	\centering
	\input{content/tables/tabLog22.tex}
	\label{tab:dataW2_2}
%\end{table}
\end{minipage}
\end{table}
