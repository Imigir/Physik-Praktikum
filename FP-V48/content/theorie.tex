...
\[
\int_{t(T)}^{\inf}i(t')\mathrm{d}t'=-F P(t),
\]
also eingesetzt in \eqref{eq:DGL}, unter Berücksichtigung, dass $T$ eine lineare Funktion von $t$ mit Steigung $b$ ist und mit Gleichung \eqref{eq:tau}
\begin{equation}
\mathrm{e}^{-\frac{W}{k_.BT}}=\frac{\int_{T}^{\inf}i(T')\mathrm{d}T'}{b\tau_.0 i(T)}
\end{equation}
