...
\begin{table}
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\input{content/tables/tabStabRundEinseitig1.tex}
	\end{minipage}
	\begin{minipage}{0.5\textwidth}
		\centering
		\input{content/tables/tabStabRundEinseitig2.tex}
	\end{minipage}
\end{table}
...
\begin{table}
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\input{content/tables/tabStabQuadratEinseitig1.tex}
	\end{minipage}
	\begin{minipage}{0.5\textwidth}
		\centering
		\input{content/tables/tabStabQuadratEinseitig2.tex}
	\end{minipage}
\end{table}
...
\begin{table}
	...
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\input{content/tables/tabStabQuadratBeidseitig1.tex}
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\input{content/tables/tabStabQuadratBeidseitig2.tex}
	\end{minipage}
\end{table}
\begin{figure}
	\centering
