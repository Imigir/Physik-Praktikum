...
Ein vollkommenes Vakuum zu erzeugen ist nicht möglich, doch es gibt Pumpen die Vakuen verschiedener Qualität erzeugen können. Die Grenze zum obersten als Vakuum bezeichneten Druckbereich, dem Grobvakuum ($300 \text{ bis } \SI{1}{\milli\bar}$), ist durch den niedrigsten natürlich auf der Erde vorkommenden Druck gegeben. Weitere Bereiche sind das Feinvakuum ($1 \text{ bis } \SI{e-3}{\milli\bar}$), das Hochvakuum ($10^{-3} \text{ bis } \SI{e-7}{\milli\bar}$) und das Ultrahochvakuum ($10^{-7} \text{ bis } \SI{e-12}{\milli\bar}$).\\
