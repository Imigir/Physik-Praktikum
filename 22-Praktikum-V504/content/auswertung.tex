...
%\input{content/tables/tab21.tex}
%\input{content/tables/tab22.tex}
\input{content/tables/tab21-3.tex}
\label{tab:1}
\end{table}
...
\input{content/tables/tab24.tex}
\input{content/tables/tab25.tex}
\label{tab:2}
\end{table}
...
\input{content/tables/tabAnlaufstrom.tex}
...
\input{content/tables/tabSTA.tex}
\label{tab:STA}
\end{table}