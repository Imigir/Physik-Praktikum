...
sind im Graph \ref{fig:abb2}
gegeneinander aufgetragen. Mittels linearer ergibt sich hier als Achsenabschnitt $T_.0^2=\SI{5,0(2)}{\second\squared}\]
...
Aus Formel \eqref{eq:I_K} folgt mit den Messwerten aus Tabelle \ref{tab:tab6}
berechnen:
