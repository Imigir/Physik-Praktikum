...
\[\sigma_.{I_.{Kugel}}= \sqrt{\left(\frac{\mathrm{d}(I_.K)}{\mathrm{d}(T^2_.0)} \cdot \sigma_.{T^2_.0}\right)^2+\left(\frac{\mathrm{d}(I_.K)}{\mathrm{d}D}\cdot\sigma_.D\right)^2+\left(\frac{\mathrm{d}(I_.K)}{\mathrm{d}(I_.D)} \cdot \sigma_.{I_.D}\right)^2},\]
