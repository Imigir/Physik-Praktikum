...
#a)
paramsLinear, errorsLinear ,sigma_y = linregress(t[0:30], noms(N[0:30]))
...
#print('N_min =', N_min)
#print('Steigung der logarithmisierten Kurve =', steigung/N_min*100*100)
print('Der Achsenabschnitt ist =', achsenAbschnitt)
...
plt.plot(x_plot, x_plot*paramsLinear[0]+paramsLinear[1], 'b-', linewidth=0.8, label='Ausgleichsgerade der logarithmierten Zerfallskurve')
plt.xlabel(r'$t/\si{\second}$')
plt.ylabel(r'$ln(N)/ln(\si{\becquerel})$')
plt.xlim(0,1000)
plt.legend(loc="best")
