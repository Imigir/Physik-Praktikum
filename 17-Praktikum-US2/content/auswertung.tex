...
\begin{table}
	...
	\input{content/tables/tabAScan2MHzRef.tex}
	\label{tab:AScanRef}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabAScan2MHz.tex}
	\label{tab:AScan2MHz}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabAScan4MHz.tex}
	\label{tab:AScan4MHz}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabBScan.tex}
	\label{tab:BScan}
\end{table}
...
\[
V_.{Schlag}=\SI{29,4(3)e-6}{\cubic\metre}
\]
...
\[
V_.{Zeit} = V_.{Schlag} \cdot f =\SI{16,5(4)e-6}{\cubic\metre\per\second}\text{.}
\]
...
\begin{table}
	...
	\input{content/tables/tabTMScan.tex}
	\label{tab:TMScan}
\end{table}
