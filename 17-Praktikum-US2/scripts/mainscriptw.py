...
makeTable([n, l_oben, dt_oben, l_oben_exp, l_unten, dt_unten, l_unten_exp, durchmesser, durchmesser_exp, error_2], r'{'+r'$n$'+r'} & {'+r'$l_.{oben}/10^{-3}\si{\metre}$'+r'} & {'+r'$\Delta t_.{oben}/10^{-6}\si{\second}$'+r'} & {'+r'$l_.{oben_.{exp}}/10^{-3}\si{\metre}$'+r'} & {'+r'$l_.{unten}/10^{-3}\si{\metre}$'+r'} & {'+r'$\Delta t_.{unten}/10^{-6}\si{\second}$'+r'} & {'+r'$l_.{unten_.{exp}}/10^{-3}\si{\metre}$'+r'} & {d/10^{-3}\si{\metre}$'+r'} & {'+r'$d_.{exp}/10^{-3}\si{\metre}$'+r'} & {'+r'$\Delta d/\%$'+r'}', 'tabAScan2', ['S[table-format=1.0]', 'S[table-format=2.1]', 'S[table-format=2.2]', 'S[table-format=2.2]', 'S[table-format=2.1]', 'S[table-format=2.2]', 'S[table-format=2.2]', 'S[table-format=2.2]', 'S[table-format=2.2]', 'S[table-format=2.1]'], ["%1.0f", "%2.1f", "%2.2f", "%2.2f", "%2.1f", "%2.2f", "%2.2f", "%2.2f", "%2.2f","%2.1f"])
