...
In Tabelle \ref{tab:ZWerte} befinden sich Werte die für spätere Rechnungen benötigt werden.

\begin{table}
	\centering
	\caption{Einige Werte für Gold, Aluminium und Bismut.}
