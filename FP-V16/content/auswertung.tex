...
\begin{table}
	...
	\input{content/tables/tabZWerte_korrekt.tex}
	\label{tab:values}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabDataOhne.tex}
	\label{tab:dataOhne}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabDataMit.tex}
	\label{tab:dataMit}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabDataDeg.tex}
	\label{tab:dataDeg}
\end{table}
...
Bei einer Messzeit von $t=\SI{300}{\second}$ ergeben sich für eine $\SI{2}{\milli\metre}$ und eine $\SI{4}{\milli\metre}$ dicke Folie Zählraten von $N_{2.{mm}}=\num{2156(47)}$ und $N_{4.{mm}}=\num{1452(39)}$.
Für die Intensität $I$ folgt:
\begin{align*}
I_{2.{mm}} &= \SI{7.19(16)}{\per\second}\\
I_{4.{mm}} &= \SI{4.84(13)}{\per\second}\text{.}
\end{align*}
...
\begin{table}
	...
	\input{content/tables/tabZAbh.tex}
	\label{tab:ZAbh}
\end{table}
