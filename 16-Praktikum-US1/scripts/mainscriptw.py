...
plt.plot(t*1000000, l, 'rx', linewidth=0.8, label='Messwerte')
plt.plot(x_plot, x_plot/1000000*paramsLinear[0]+paramsLinear[1], 'k-', linewidth=0.8, label='Ausgleichsgerade')
plt.xlabel(r'$t/10^{-6}\si{\second}$')
plt.ylabel(r'$l/\si{\metre}$')
plt.xlim(0,50)
plt.ylim(0,15/100)
plt.legend(loc="best")
