...
\begin{table}
	...
	\input{content/tables/tabSchallgeschwindigkeit.tex}
	\label{tab:SchallIE}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabSchallgeschwindigkeitDurchschallung.tex}
	\label{tab:SchallD}
\end{table}
...
\begin{table}
	...
	\input{content/tables/tabDaempfung.tex}
	\label{tab:Daempfung}
\end{table}
...
\noindent Bei der Fourier transformierten ist ein Maximum bei $\SI{}{\mega\hertz}$ zu erkennen.
Die Laufzeiten des Schalls in den Acrylplatten lassen sich aus dem Cepstrum zu $\Delta t=\SI{}{\second}$ bestimmen.
...
\begin{table}
	...
	\input{content/tables/tabAuge.tex}
	\label{tab:Auge}
\end{table}
