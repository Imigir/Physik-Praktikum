...
%\label{tab:tab6}
%	\sisetup{table-format=1.2}
%	\begin{tabular}{cS[table-format=2.3]S[table-format=2.2]S[table-%format=1.2]}
%		\toprule
%		{} & {$\nu_.exp/ 10^3 \si{\hertz}$} & {$\nu_.{theo}/%10^3\si{\hertz}$} & {$\Delta\nu/\si{}$} \\
%		\midrule
%		$\nu_.1$ & ${32,740 \pm 0,019}$ & ${33,66\pm 0,07}$ & 2,73\% \\
%		$\nu_.2$ & ${33,979 \pm 0,020}$ & ${35,48\pm 0,07}$ & 4,23\% \\
%		\bottomrule
%	\end{tabular}
%\end{table