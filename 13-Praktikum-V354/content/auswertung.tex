...
\Delta q = 18,65\%
\]
Die gemessene Breite der Resonanzkurve ergibt sich mit $\nu_.-=○\SI{3,2459(16)e4}{\hertz}$ und $\nu_.+\SI{3,4277(16)}{\hertz}=$:
\[
(\nu_.+-\nu_.-)_.{exp}=\SI{1,818(20)e3}{\hertz}
\]
Mit den aus Gleichung \eqref{eq:} berechneten $\nu_.-=\SI{3,361(7)e4}{\hertz}$ und $\nu_.+={3,543(7)e4}{\hertz}$ beträgt
\[
(\nu_.+-\nu_.-)_.{theo}=\SI{1,821(20)e3}{\hertz}\text{.}
\]
