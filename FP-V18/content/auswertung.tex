...
\begin{table}
	...
	\input{content/tables/a-korrekteFehler.tex}
...
\begin{table}
	...
	\input{content/tables/a2-korrekteFehler.tex}
	\label{tab:Q}
\end{table}
...
\begin{table}
	...
	\input{content/tables/b-korrekteFehler.tex}
...
\begin{table}
	\centering
	\caption{Die Parameter der Ausgleichsgeraden zur Bestimmung der Halbwertsbreite (HWB) und Zehntelwertsbreite (ZWB) des Vollenergiepeaks des Spektrums von $^{137}.{Cs}$.}
	\input{content/tables/geraden1-korrekteFehler.tex}
...
\begin{table}
	...
	\input{content/tables/geraden2-korrekteFehler.tex}
...
\begin{table}
	...
	\input{content/tables/D-korrekteFehler.tex}
...
\begin{table}
	...
	\input{content/tables/D2-korrekteFehler.tex}
	\label{tab:ABa}
\end{table}
...
\begin{table}
	...
	\input{content/tables/unbekannt-korrekteFehler.tex}
...
\begin{table}
	...
	\input{content/tables/unbekannt2-korrekteFehler.tex}
